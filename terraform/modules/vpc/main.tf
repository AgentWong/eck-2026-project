...
module "vpc" {
  ...
  single_nat_gateway   = true # Cost optimization: ~$1/day
...
output "nat_gateway_public_ip" {
  description = "Public EIP of the NAT Gateway. Pods egress via this IP, so ALBs restricting inbound-cidrs must allow it."
